...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BondripiaBlockEntity>> BONDRIPIA = BLOCK_ENTITIES.register("bondripia", () -> BlockEntityType.Builder.of(BondripiaBlockEntity::new, ModBlocks.BONDRIPIA.get()).build(null));
